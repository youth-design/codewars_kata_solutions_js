...
describe("SQL tests", function() {
    it("Basic SELECT tests", function() {
        var numbers = [1, 2, 3];
        Test.assertDeepEquals(query().select().from(numbers).execute(), numbers);
        Test.assertDeepEquals(query().select().execute(), [], 'No FROM clause produces empty array');
        Test.assertDeepEquals(query().from(numbers).execute(), numbers, 'SELECT can be omited');
        Test.assertDeepEquals(query().execute(), []);
        Test.assertDeepEquals(query().from(numbers).select().execute(), numbers, 'The order does not matter');
    });
    ...
    it("Basic SELECT and WHERE over objects", function() {
        ...
        Test.assertDeepEquals(query().select().from(persons).execute(), persons);
        ...
        Test.assertDeepEquals(query().select(profession).from(persons).execute(),  ["teacher","teacher","teacher","scientific","scientific","scientific","politician"]);
        Test.assertDeepEquals(query().select(profession).execute(), [], 'No FROM clause produces empty array');
        ...
        Test.assertDeepEquals(query().select(profession).from(persons).where(isTeacher).execute(), ["teacher", "teacher", "teacher"]);


        //SELECT * FROM persons WHERE profession="teacher"
        Test.assertDeepEquals(query().from(persons).where(isTeacher).execute(), persons.slice(0, 3));
        ...
        Test.assertDeepEquals(query().select(name).from(persons).where(isTeacher).execute(), ["Peter", "Michael", "Peter"]);
        Test.assertDeepEquals(query().where(isTeacher).from(persons).select(name).execute(), ["Peter", "Michael", "Peter"]);
    ...
    it('GROUP BY tests', function() {
        ...
        Test.assertDeepEquals(query().select().from(persons).where(isTeacher).groupBy(profession).execute(),  [["teacher",[{"name":"Peter","profession":"teacher","age":20,"maritalStatus":"married"},{"name":"Michael","profession":"teacher","age":50,"maritalStatus":"single"},{"name":"Peter","profession":"teacher","age":20,"maritalStatus":"married"}]]]);
        ...
        Test.assertDeepEquals(query().select(professionGroup).from(persons).groupBy(profession).execute(), ["teacher","scientific","politician"]);
        ...
        Test.assertDeepEquals(query().select(professionCount).from(persons).groupBy(profession).orderBy(naturalCompare).execute(), [["politician",1],["scientific",3],["teacher",3]]);
    });
    ...
    it('Numbers tests', function() {
        ...
        Test.assertDeepEquals(query().select().from(numbers).groupBy(parity).execute(), [["odd",[1,3,5,7,9]],["even",[2,4,6,8]]]);

        //SELECT * FROM numbers GROUP BY parity, isPrime
        Test.assertDeepEquals(query().select().from(numbers).groupBy(parity, prime).execute(), [["odd",[["divisible",[1,9]],["prime",[3,5,7]]]],["even",[["prime",[2]],["divisible",[4,6,8]]]]]);
        ...
        Test.assertDeepEquals(query().select().from(numbers).groupBy(parity).having(odd).execute(), [["odd",[1,3,5,7,9]]]);
        ...
        Test.assertDeepEquals(query().select().from(numbers).orderBy(descendentCompare).execute(), [9,8,7,6,5,4,3,2,1]);
        ...
        Test.assertDeepEquals(query().select().from(numbers).where(lessThan3, greaterThan4).execute(),  [1,2,5,6,7,8,9]);
    });
    ...
    it('Frequency tests', function() {
        ...
        Test.assertDeepEquals(query().select(sumValues).from(persons).orderBy(naturalCompare).groupBy(nameGrouping).execute(),  [["Anna",4],["Michael",10],["Peter",10]]);
        ...
        Test.assertDeepEquals(query().select(frequency).from(numbers).groupBy(id).execute(), [{"value":1,"frequency":3},{"value":2,"frequency":2},{"value":3,"frequency":1},{"value":5,"frequency":2},{"value":6,"frequency":2}]);
        ...
        Test.assertDeepEquals(query().select(frequency).from(numbers).groupBy(id).having(greatThan1).having(isPair).execute(),  [{"value":2,"frequency":2},{"value":6,"frequency":2}]);
    ...
    it('join tests', function() {
        ...
        Test.assertDeepEquals(query().select(student).from(teachers, students).where(teacherJoin).execute(), [{"studentName":"Michael","teacherName":"Peter"},{"studentName":"Rose","teacherName":"Anna"}]);


        var numbers1 = [1, 2];
        var numbers2 = [4, 5];

        Test.assertDeepEquals(query().select().from(numbers1, numbers2).execute(), [[1,4],[1,5],[2,4],[2,5]]);
        ...
        Test.assertDeepEquals(query().select(student).from(teachers, students).where(teacherJoin).where(tutor1).execute(), [{"studentName":"Michael","teacherName":"Peter"}]);
